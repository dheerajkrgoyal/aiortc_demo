...
function start() {
    ...
    if (document.getElementById('use-datachannel').checked) {
        ...
        dc.addEventListener('close', () => {
            ...
            dataChannelLog.textContent += 'Bot- Terminating the session. Will see you soon!\n';
        });
        dc.addEventListener('open', () => {
            dataChannelLog.textContent += 'Bot- Hi, You can ask me anything\n';
        ...
        dc.addEventListener('message', (evt) => {
            dataChannelLog.textContent += 'Bot- ' + evt.data + '\n';
            translator.speakTextUsingRobot(evt.data, {
    ...
    translator.voiceToText(function(text) {
        dataChannelLog.textContent += 'Dheeraj- ' + text + '\n';
        dc.send(text)
    }, "en-US");
